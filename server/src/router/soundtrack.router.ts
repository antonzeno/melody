...
export default (router: express.Router) => {
    ...
    router.post('/soundtrack/upload', async (request: express.Request, response: express.Response) => {
        try {
    ...
    router.get('/soundtrack/:id', async (request: express.Request, response: express.Response) => {
        try {
    ...
    router.put('/soundtrack/upload/:id?', async (request: express.Request, response: express.Response) => {
        try {
            const { id } = request.params;
            console.log(id)
